...
class participant(models.Model):
    ...
    deferral_eligible=models.BooleanField(blank=True,null=True,default=False)
    match_eligible=models.BooleanField(blank=True,null=True,default=False)
    profit_share_eligible=models.BooleanField(blank=True,null=True,default=False)
