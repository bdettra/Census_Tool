...
class ParticipantSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        "total_EE_deferral","total_ER_deferral","effective_deferral_percentage","selection","key_employee",'deferral_eligible','match_eligible','profit_share_eligible',
        "participating","contributing","engagement",'error_set',]